...
namespace MultiplayerGame.Networking.Messages
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public class RemoveFromGridMessage : IGameMessage
    {
        ...
        /// The im.
        /// </param>
        public RemoveFromGridMessage(NetIncomingMessage im)
        {
            this.Decode(im);
        }


        public RemoveFromGridMessage(Tile tile,string playerID,float scale)
        {
            this.ID = tile.ID;
        ...
        public GameMessageTypes MessageType
        {
            get
            {
                return GameMessageTypes.RemoveFromGridState; //TODO: update message type
            }
        }
