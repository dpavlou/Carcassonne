...
namespace MultiplayerGame.Networking.Messages
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public class AddTemplateMessage : IGameMessage
    {
        ...
        /// The im.
        /// </param>
        public AddTemplateMessage(NetIncomingMessage im)
        {
            this.Decode(im);
        }


        public AddTemplateMessage(string name, int pos, string sender)
        {
            this.Name = name;
            this.Pos = pos;
            this.Sender = sender;
        ...
        public GameMessageTypes MessageType
        {
            get
            {
                return GameMessageTypes.AddTemplateState;
            }
        }
