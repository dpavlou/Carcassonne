...
namespace MultiplayerGame.Networking.Messages
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public class AddTileMessage : IGameMessage
    {
        ...
        /// The im.
        /// </param>
        public AddTileMessage(NetIncomingMessage im)
        {
            this.Decode(im);
        }


        public AddTileMessage(string codeValue, int id,int Count)
        {
            this.ID = id;
        ...
        public GameMessageTypes MessageType
        {
            get
            {
                return GameMessageTypes.AddTileState;
            }
        }
